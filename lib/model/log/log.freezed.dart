...
mixin _$Log {
  ...
  String get logGroupId => throw _privateConstructorUsedError;
...
abstract class $LogCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {String id, String description, DateTime createdAt, String logGroupId});
}
    ...
    return _then(_value.copyWith(
      ...
      createdAt: null == createdAt
          ...
          : createdAt // ignore: cast_nullable_to_non_nullable
              as DateTime,
      logGroupId: null == logGroupId
          ? _value.logGroupId
          : logGroupId // ignore: cast_nullable_to_non_nullable
              as String,
    ) as $Val);
  }
}
...
class _$LogImpl extends _Log {
  ...
  @override
  final String logGroupId;

  @override
  String toString() {
    return 'Log(id: $id, description: $description, createdAt: $createdAt, logGroupId: $logGroupId)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.logGroupId, logGroupId) ||
                other.logGroupId == logGroupId));
  }

  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, description, createdAt, logGroupId);
...
abstract class _Log extends Log {
  const factory _Log(
      ...
      required final String logGroupId}) = _$LogImpl;
